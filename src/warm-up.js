...
var sequel = `${title} gets owned by Snape`;
...
if (isFavorite === true) {
    ...
    console.log(`I recently read ${title} and it was kind of garbage.`);
}
...
var belowTwoHundred = [3, 30, 33, 39, 113, 137, 135, 132, 153, 173, 193, 1];
